...
import { ArrowUp, ClipboardCopy, File, Signature, TableColumnsSplit } from "lucide-react";
...
const Skeleton = () => (
  <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-purple-400 dark:from-neutral-900 dark:to-neutral-800 to-teal-100"></div>
);
const items = [
  {
