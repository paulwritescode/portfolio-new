    ...
    <>
      <div className="flex flex-col">
        <TypewriterEffectSmooth
          className="text-black dark:text-white justify-center md:justify-start flex text-center items-center"
          words={introName}
        />
        <Highlight className="text-white text-xl font-bold ">
          Software Engineer, AWS Certified Cloud Practitioner
        </Highlight>
        <p className="text-xl md:text-2xl lg:text-2xl text-center md:text-left text-black dark:text-gray-300 leading-relaxed lg:leading-snug  ">
